...
function gtg_enqueue_scripts() {
    wp_enqueue_script('gtg-ajax-script', plugin_dir_url(__FILE__) . 'gtg-script.js', array('jquery'), null, true);
    wp_localize_script('gtg-ajax-script', 'gtg_ajax_obj', array('ajax_url' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('gtg_nonce')));
    wp_enqueue_style('gtg-styles', plugin_dir_url(__FILE__) . 'gtg-style.css');
